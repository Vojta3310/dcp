...
Podařilo se natrénovat DCP na dvou po sobě jdoucích lidarových záběrech, tak, že z každého záběru bylo použito jen $N$ náhodných bodů. Výsledek testu sítě je na obr. \ref{fig:1}. 

Dále byla síť trénována na všech dvojicích obsahujících společnou část, tím se zvětšil dataset a trénování jsem nestihly dokončit. 
